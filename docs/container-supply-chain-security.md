...
the application image lineage. `whatsapp-migrator` runs as non-root under
`USER bun`, matching the API and worker runtime hardening.
...
findings in ncurses, systemd, acl, util-linux, and perl-Archive-Tar. PR #140
