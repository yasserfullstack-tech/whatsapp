...
4. Confirm `main` branch protection and required release-relevant status checks (CI, Security, Production Infra, representative load gate) are enforced — ruleset `main-release-controls` (id `23732752`), tracking issue [#91](https://github.com/yasserfullstack-tech/whatsapp/issues/91) (closed 2026-09-20, verified via [PR #100](https://github.com/yasserfullstack-tech/whatsapp/pull/100) red case and [PR #96](https://github.com/yasserfullstack-tech/whatsapp/pull/96) green case).
5. Confirm the current Load Smoke workflow is green on the release commit — tracking issue [#90](https://github.com/yasserfullstack-tech/whatsapp/issues/90) (closed 2026-09-20, green on `main` since 2026-09-19).
