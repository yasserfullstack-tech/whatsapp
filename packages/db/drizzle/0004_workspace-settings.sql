...
ALTER TABLE "workspace_audit_logs" ADD CONSTRAINT "workspace_audit_logs_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "workspace_audit_logs_org_created_idx" ON "workspace_audit_logs" USING btree ("organization_id","created_at");