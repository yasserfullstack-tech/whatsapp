  ...
  return (
    <>
      ...
      <section className="panel settingsPanel">
        <div className="panelHeader"><div><h2>Connected numbers</h2><p className="subtitle">Status, quality, and throughput are kept visible together for operations.</p></div></div>
        {phoneNumbers.length ? <div className="settingsList">{phoneNumbers.map((phone) => (
          <div className="settingsListRow settingsPhoneRow" key={phone.id}>
            <div><strong>{phone.verifiedName ?? "WhatsApp Business"}</strong><p>{phone.displayPhoneNumber ?? phone.phoneNumberId}</p></div>
